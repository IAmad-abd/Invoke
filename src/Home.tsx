                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                      ...
                      <div className="tw-flex tw-items-center tw-gap-2">
                        ...
                        >
                          <a
                            ...
                            rel="noopener noreferrer"
                                                                    href="https://www.invokersnft.com/"
                          >
                            <img
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                    href="https://discord.com/invite/invokers"
                          >
                            <img
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                    href="https://twitter.com/InvokersNFT"
                          >
                            <img
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        InvokersElves is a collection that boasts products
                                                        such as Gamified Royalty System, Staking, DeFi,
                                                        Casino and MMORPG. 55% of Royalties
                    ...
                    <div className="tw-w-full">
                      <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow 3xl:tw-hidden">
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                          ...
                          <span>
                            <b className="tw-text-white-1">93%</b> (4651/5000)
                          </span>
                        </div>
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                InvokersElves is a Tech-Driven project which aims
                                                                to become a 10 project when it comes to Passive
                                                                Income + Gamification, utilizing Custom & In-
                                                                House built products.

                                                                All Elves are usable directly post mint on:

                                                              - Invokers Staking
                                                              - Invokers DeFi
                                                              - Invokers Casino
                                                              - Invokers Royalty
                                                              - & Playable in the Upcoming InvokersMMO

                                                                InvokersElves is the second collection in the
                                                                Invokers Ecosystem. Elves Collection will always
                                                                be driven by Technology & Innovation. With all
                                                                products developed without using Whitelabel
                                                                solutions, Elves will utilize its team's high level
                                                                experience to escalate its community to new
                                                                heights and promises long-lasting optimization.
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[50%]">
                      ...
                      <div className="tw-p-4">
                        <div className="tw-p-4">
                          ...
                          <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                       - Single-sided $IV Staking pool, 200%+ APY
                                                                       - Yield Farming $IV/SOL LP, 200% APY
                                                                       - Yield Farming $IV/USDC LP, 200% APY
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Partner projects tokens LP introductions
                                                                      - Stable-Coin introduction
                                                                      - Centralized Exchanges $IV listing
                                                                      - InvokersDEX creation focusing on NFT Projects tokens
                                                                      - Lending/Borrowing
                                                                      - Buy Now Pay Later (BNPL)
                                                                      - Introduction of Multipliers based on NFT rarities
                                                                      - Liquidity addition into $IV Pools to increase APY
                                                                      - Rental proposition of InvokersDeFi's products
                            </p>
                            <br />
                          </div>
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Stake InvokersNFTs & InvokersElves to earn 10-20
                                                                        $IV/Day
                                                                      - Unlocked and 7 Days, 30 Days, 60 Days Lock options
                                                                      - Utilize Private Node to increase Loading speed for large
                                                                        investors
                            </p>
                            <br />
                          </div>
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Longer Lock duration options with higher rewards
                                                                      - Automatic option to deposit claimed $IV directly InvokersDeFi, reducing fees and increasing rewards
                                                                      - Partner collections staking to earn $IV
                                                                      - Partner collections staking to earn Partner's native token
                                                                      - Rental proposition of Invokers Staking products
                            </p>
                            <br />
                          </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Gamified Royalty system integration
                                                                      - 55% of Royalties (InvokersNFT + InvokersElves)
                                                                      - $IV integration into Royalty system to add utility
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Weekly Royalties Payouts utilizing In-House built smart
                                                                        contract
                                                                      - Increased utilities addition to Invokers ecosystem to
                                                                        increase trading volume + Royalties share to holders
                                                                      - Introduction of Rarities into Royalty's system for higher
                                                                        rewards
                                                                      - Introduction of a 3D reactive Front-end
                                                                      - Scaling Invokers Collections into multiple Marketplaces
                                                                        (with ME remaining as the main/preferred Marketplace)
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Double or Nothing utilizing $IV
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Poker utilizing $IV
                                                                      - Blackjack utilizing $IV
                                                                      - Minigames such as Rock, Paper, Scissors and more
                                                                        utilizing $IV
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Multiple Gameplay Trailers + Sneakpeaks
                                                                      - Tentative InvokersMMO BETA launch date exclusive to
                                                                        Invokers holders
                                                                      - Partnerships with multiple leading Metaverse projects
                                                                        on Solana
                                                                      - Partnerships with multiple leading Game-Fi projects on
                                                                        Solana
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - InvokersMMO BETA
                                                                      - Post BETA release, collection of holders' feedback and
                                                                        improvement
                                                                      - Post feedback and improvement, re-open to additional
                                                                        20,000 members
                                                                      - Post 20,000 members feedback and improvement, open
                                                                        to general public
                                                                    </p>
                                                                    <br />
                                                                </div>
